...
module.exports = {
  ...
  cards: {
    number: Math.floor(Math.random() * 5000000000),
    minRare: Math.floor(Math.random() * 5000),
    minEpic: Math.floor(Math.random() * 50000000),
  },
  gold: {
    min: Math.floor(Math.random() * 50000000),
    max: (Math.floor(Math.random() * 5000000000) + 50000000000),
  },
